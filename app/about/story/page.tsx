...
import AboutCarouselSection from "@/components/AboutCarouselSection";
...
export default function AboutStoryPage() {
    ...
    const carouselSection = getSection("about_carousel_section");
    const timelineSection = getSection("about_timeline_section");
        ...
        <main className="min-h-screen bg-white">
            ...
            {carouselSection && (
                <AboutCarouselSection
                    data={carouselSection.settings as any}
                    isEditMode={isEditMode}
                    onUpdate={(newSettings) => updateSection(carouselSection.id, newSettings)}
                />
            )}
            ...
            {timelineSection && (
                <AboutTimelineSection
                    data={timelineSection.settings as any}
                    isEditMode={isEditMode}
                    onUpdate={(newSettings) => updateSection(timelineSection.id, newSettings)}
                />
            )}
