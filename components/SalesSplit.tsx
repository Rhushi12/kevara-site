...
export default function SalesSplit({ data, isEditMode = false, onUpdate }: SalesSplitProps) {
    ...
    return (
        <section className="container mx-auto px-4 py-12 relative">
            ...
            <div
                className="flex md:grid gap-4 md:gap-8 overflow-x-auto pb-4 md:pb-0 -mx-4 px-4 md:mx-0 md:px-0 snap-x snap-mandatory scrollbar-hide max-w-[100vw] touch-manipulation"
                style={{
